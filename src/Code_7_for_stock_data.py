...
def pd_data_000001SS():
    ...
    #df_aapl = web.DataReader("AAPL", "iex")
    #print(df_aapl.head())

    df_stockload = web.DataReader("000001.SS", "yahoo", datetime.datetime(2019,1,1), datetime.datetime(2019,6,1))
...
# 设置token
token = '' # 输入你的token
pro = ts.pro_api('64532b1c03637bc0c3ac92931a5d1b53cfaf75de87c22dfdc70ca6a0') # 初始化pro接口
